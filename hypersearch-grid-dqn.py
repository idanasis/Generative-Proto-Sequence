...
@dataclass
class Config:
    file_to_replace: str = "sbatch_dqn"
    original_command_pattern: str = "poetry run python dqn_simplegrid_levels.py"
...
def hypersearch(cfg: Config):
    ...
    if cfg.top_k > 0:
        ATTR_MATCHING_L: list[str] = ['train_dataset_size', 'total_timesteps', 'obstacle_map', 'dqn_linear_layers', 'buffer_size',
                                      'max_level', 'start_level', 'reward_strategy', 'seed']
